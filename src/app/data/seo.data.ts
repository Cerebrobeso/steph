export const seoData = {
  ...
  description:
    'Portfolio di Stefano, Sono un Frontend Developer con oltre 5 anni di esperienza nello sviluppo di applicazioni web e mobile. Scopri i miei progetti web e le mie competenze nello sviluppo frontend e backend.',
